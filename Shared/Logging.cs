...
namespace SyncToAsync.Shared
{
    ...
    public static class Logging
    {
        ...
        // Logs go to: C:\Users\<user>\AppData\Local\Temp\sync2async_extension.*.log
        // We're using one log file for each process to prevent concurrent file access.
        private static readonly string vsLogFile = $"{Path.GetTempPath()}/sync2async_extension.vs.log";
        private static readonly string clLogFile = $"{Path.GetTempPath()}/sync2async_extension.codelens.log";
